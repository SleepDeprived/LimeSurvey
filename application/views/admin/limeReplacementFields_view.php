...
<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
    <tr>
        ...
        <?php
            ...
            ?>
            <select name='cquestions' id='cquestions' style='font-family: Proxima Nova, verdana; background-color: #FFFFFF; font-size:10; border: 0px;width:20em;' size='14' ondblclick="$('.cke_dialog_ui_button_ok').children().click();">
                <?php
                    $noselection = false;
                }
                else
